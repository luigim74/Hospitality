...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDitte))
...
#End Region
   ...
   Const NOME_TABELLA As String = "Ditte"
   ...
   Private Function SalvaDati() As Boolean
      ...
      Try
         ...
         ADitte.Codice = txtCodice.Text
         ADitte.RagSoc = txtRagSoc.Text
         ADitte.Titolo = cmbTitolo.Text
         ADitte.CodFisc = txtCodFisc.Text
         ADitte.PIva = txtPIva.Text
         ADitte.Indirizzo1 = txtIndirizzo1.Text
         ADitte.Indirizzo2 = txtIndirizzo2.Text
         ADitte.Cap = txtCap.Text
         ADitte.Città = txtCittà.Text
         ADitte.Provincia = txtProv.Text
         ADitte.Regione = txtRegione.Text
         ADitte.Nazione = cmbNazione.Text
         ADitte.TipoCliente = cmbTipoCliente.Text
         ADitte.TelCasa = txtTelCasa.Text
         ADitte.TelUfficio = txtTelUfficio.Text
         ADitte.Cell = txtCell.Text
         ADitte.Fax = txtFax.Text
         ADitte.Email = txtEmail.Text
         ADitte.Internet = txtInternet.Text
         ADitte.CamereNum1 = txtCameraNum_0.Text
         ADitte.CamereNum2 = txtCameraNum_1.Text
         ADitte.CamereNum3 = txtCameraNum_2.Text
         ADitte.CamereNum4 = txtCameraNum_3.Text
         ADitte.CamereNum5 = txtCameraNum_4.Text
         ADitte.CamereData1 = txtCameraData_0.Text
         ADitte.CamereData2 = txtCameraData_1.Text
         ADitte.CamereData3 = txtCameraData_2.Text
         ADitte.CamereData4 = txtCameraData_3.Text
         ADitte.CamereData5 = txtCameraData_4.Text
         ADitte.CamereNotti1 = txtCameraNotti_0.Text
         ADitte.CamereNotti2 = txtCameraNotti_1.Text
         ADitte.CamereNotti3 = txtCameraNotti_2.Text
         ADitte.CamereNotti4 = txtCameraNotti_3.Text
         ADitte.CamereNotti5 = txtCameraNotti_4.Text
         ADitte.Strutture = cmbStruttura.Text
         ADitte.Note = txtNote.Text
         ...
         If Me.Tag <> "" Then
            Return ADitte.ModificaDati(NOME_TABELLA, Me.Tag)
         Else
            Return ADitte.InserisciDati(NOME_TABELLA)
         End If
   ...
   Private Sub InserisciImmagine()
      Try
         ...
         ADitte.Immagine = OpenFileDialog1.FileName

         If File.Exists(ADitte.Immagine) = True Then
            Dim bmp As New Bitmap(ADitte.Immagine)
            picFoto.Image = bmp
         End If
   ...
   Private Sub frmDitte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Try
         ...
         If Me.Tag <> "" Then
            ...
            ADitte.LeggiDati(NOME_TABELLA, Me.Tag)

            ' Assegna i dati dei campi della classe alle caselle di testo.
            txtCodice.Text = ADitte.Codice
            txtRagSoc.Text = ADitte.RagSoc
            cmbTitolo.Text = ADitte.Titolo
            txtCodFisc.Text = ADitte.CodFisc
            txtPIva.Text = ADitte.PIva
            txtIndirizzo1.Text = ADitte.Indirizzo1
            txtIndirizzo2.Text = ADitte.Indirizzo2
            txtCap.Text = ADitte.Cap
            txtCittà.Text = ADitte.Città
            txtProv.Text = ADitte.Provincia
            txtRegione.Text = ADitte.Regione
            cmbNazione.Text = ADitte.Nazione
            cmbTipoCliente.Text = ADitte.TipoCliente
            txtTelCasa.Text = ADitte.TelCasa
            txtTelUfficio.Text = ADitte.TelUfficio
            txtCell.Text = ADitte.Cell
            txtFax.Text = ADitte.Fax
            txtEmail.Text = ADitte.Email
            txtInternet.Text = ADitte.Internet
            txtCameraNum_0.Text = ADitte.CamereNum1
            txtCameraNum_1.Text = ADitte.CamereNum2
            txtCameraNum_2.Text = ADitte.CamereNum3
            txtCameraNum_3.Text = ADitte.CamereNum4
            txtCameraNum_4.Text = ADitte.CamereNum5
            txtCameraData_0.Text = ADitte.CamereData1
            txtCameraData_1.Text = ADitte.CamereData2
            txtCameraData_2.Text = ADitte.CamereData3
            txtCameraData_3.Text = ADitte.CamereData4
            txtCameraData_4.Text = ADitte.CamereData5
            txtCameraNotti_0.Text = ADitte.CamereNotti1
            txtCameraNotti_1.Text = ADitte.CamereNotti2
            txtCameraNotti_2.Text = ADitte.CamereNotti3
            txtCameraNotti_3.Text = ADitte.CamereNotti4
            txtCameraNotti_4.Text = ADitte.CamereNotti5
            cmbStruttura.Text = ADitte.Strutture
            txtNote.Text = ADitte.Note

            If ADitte.Immagine <> Nothing Then
               If File.Exists(ADitte.Immagine) = True Then
                  Dim bmp As New Bitmap(ADitte.Immagine)
                  picFoto.Image = bmp
               End If
