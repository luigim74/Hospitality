...
#Region " Codice generato da Progettazione Windows Form "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    "o deil punti:"
      ...
      Me.ClientSize = New System.Drawing.Size(791, 577)
...
#End Region
   ...
   Const NUMERO_DOC As Integer = 24
...
#End Region
   ...
   Public Sub CaricaListaReports(ByVal cmb As ComboBox)
      Try
         ...
         documenti(5) = REPORT_PROFORMA_A4_DOPPIA
         documenti(6) = REPORT_PROFORMA_A5
         documenti(7) = REPORT_PROFORMA_A6
         documenti(8) = REPORT_COMANDA_REPARTI
         documenti(9) = REPORT_COMANDA_CLIENTI
         documenti(10) = REPORT_COMANDA_REPARTI_KUBEII
         documenti(11) = REPORT_COMANDA_CLIENTI_KUBEII
         documenti(12) = REPORT_RICEVUTA_BELLA_NAPOLI
         documenti(13) = REPORT_FATTURA_BELLA_NAPOLI
         documenti(14) = REPORT_PROFORMA_BELLA_NAPOLI
         documenti(15) = REPORT_PROFORMA_KUBEII
         documenti(16) = REPORT_RICEVUTA_A4_DOPPIA_CENTRO_SPORTIVO
         documenti(17) = REPORT_FATTURA_A4_DOPPIA_CENTRO_SPORTIVO
         documenti(18) = REPORT_PROFORMA_A4_DOPPIA_CENTRO_SPORTIVO
         documenti(19) = REPORT_RICEVUTA_CELIDE
         documenti(20) = REPORT_FATTURA_CELIDE
         documenti(21) = REPORT_PROFORMA_CELIDE
         documenti(22) = REPORT_RICEVUTA_FORCHETTA_DORO
         documenti(23) = REPORT_FATTURA_FORCHETTA_DORO
         documenti(24) = REPORT_PROFORMA_FORCHETTA_DORO
         'documenti(25) = REPORT_RICEVUTA_KUBEII
         'documenti(26) = REPORT_FATTURA_KUBEII
