         ...
         Select Case TipoElenco
            ...
            Case Elenco.Sale
               If IsNothing(g_frmVCTavoli) = False Then
                  ' Aggiorna Visual POS
                  MessageBox.Show("Non Ë possibile eliminare una sala perchË Visual POS Ë in esecuzione." & vbCrLf & _
            ...
            Case Elenco.Tavoli
               If IsNothing(g_frmVCTavoli) = False Then
                  ' Aggiorna Visual POS
                  MessageBox.Show("Non Ë possibile eliminare un tavolo perchË Visual POS Ë in esecuzione." & vbCrLf & _
                                  "Si consiglia di chiudere Visual POS e ripetere l'operazione.", NOME_PRODOTTO, MessageBoxButtons.OK, MessageBoxIcon.Information)
                  Exit Sub
               End If
      ...
      Try
         ...
         Select Case TipoElenco
            ...
            Case Elenco.Sale
               ...
               If IsNothing(g_frmVCTavoli) = False Then
                  ' Aggiorna Visual POS
                  MessageBox.Show("Non Ë possibile modificare o creare una nuova sala perchË Visual POS Ë in esecuzione." & vbCrLf & _
                                  "Si consiglia di chiudere Visual POS e ripetere l'operazione.", NOME_PRODOTTO, MessageBoxButtons.OK, MessageBoxIcon.Information)
                  Exit Sub
               End If
            ...
            Case Elenco.Tavoli
               ...
               If IsNothing(g_frmVCTavoli) = False Then
                  ' Aggiorna Visual POS
                  MessageBox.Show("Non Ë possibile modificare o creare un nuovo tavolo perchË Visual POS Ë in esecuzione." & vbCrLf & _
                                  "Si consiglia di chiudere Visual POS e ripetere l'operazione.", NOME_PRODOTTO, MessageBoxButtons.OK, MessageBoxIcon.Information)
                  Exit Sub
               End If
